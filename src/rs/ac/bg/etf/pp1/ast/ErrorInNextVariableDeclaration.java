...
public class ErrorInNextVariableDeclaration extends NextVarDecl {

    private NextVarDecl NextVarDecl;

    public ErrorInNextVariableDeclaration (NextVarDecl NextVarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ErrorInNextVariableDeclaration(\n");
