...
public class NextActualParameter extends ActParsNext {

    private ActParsNext ActParsNext;
    private ActParam ActParam;

    public NextActualParameter (ActParsNext ActParsNext, ActParam ActParam) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("NextActualParameter(\n");
